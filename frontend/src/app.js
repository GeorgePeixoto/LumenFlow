...
document.addEventListener('DOMContentLoaded', () => {
  ...
  Router.register('/reports',      requireAuth((content) => { content.innerHTML = '<div class="text-center py-16 text-gray-500 dark:text-gray-400">Relatórios — Em construção.</div>'; }));
