(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=Object.freeze({API_BASE_URL:`http://localhost:8000/api`,FIREBASE_RTDB_URL:`https://projeto-pi-bf5a6-default-rtdb.firebaseio.com`,APP_NAME:`LumenFlow`,VERSION:`0.2.0`,DEFAULT_LOCALE:`pt-BR`,POLLING_INTERVAL_MS:2e3,TOAST_DURATION_MS:5e3,TOKEN_STORAGE_KEY:`ef_token`,REMEMBER_STORAGE_KEY:`ef_remember`,DEMO_MODE:!1});console.log(`[${e.APP_NAME}] config.js carregado — API: ${e.API_BASE_URL}`);var t=(()=>{let e=[],t=null,n={},r={};function i(e){let t=[],n=e.replace(/:([^/]+)/g,(e,n)=>(t.push(n),`§§PARAM§§`)).replace(/[.*+?^${}()|[\]\\]/g,`\\$&`).replace(/§§PARAM§§/g,`([^/]+)`);return{regex:RegExp(`^${n}$`),keys:t}}function a(t,n){let{regex:r,keys:a}=i(t);e.push({regex:r,keys:a,handler:n})}function o(e){t=e}function s(){let e=window.location.hash;if(!e)return`/`;let t=e.slice(1),n=t.indexOf(`?`);return n===-1?t:t.slice(0,n)}function c(){let e=window.location.hash;if(!e)return{};let t=e.indexOf(`?`);if(t===-1)return{};let n=e.slice(t+1),r={};for(let e of n.split(`&`)){let[t,n]=e.split(`=`);t&&(r[decodeURIComponent(t)]=n?decodeURIComponent(n):``)}return r}function l(i){r=c();for(let t of e){let e=i.match(t.regex);if(e){let r={};t.keys.forEach((t,n)=>{r[t]=decodeURIComponent(e[n+1])}),n=r,t.handler(r);return}}console.warn(`[Router] No route matched: "${i}"`),t&&t({path:i})}function u(e){window.location.hash=e}function d(){window.addEventListener(`hashchange`,()=>l(s())),l(s())}function f(){return{...n}}function p(){return{...r}}return{register:a,notFound:o,navigate:u,start:d,currentParams:f,currentQuery:p}})(),n=`auth:expired`,r=`application/json`,i=d(),a=class extends Error{constructor({code:e=`HTTP_ERROR`,message:t=`Erro ao comunicar com a API.`,status:n=0,details:r=null}={}){super(t),this.name=`ApiError`,this.code=e,this.status=n,this.details=r}};function o(e){return Object.prototype.toString.call(e)===`[object Object]`}function s(e){return e.replace(/\/+$/,``)}function c(t){if(!t)return``;if(/^https?:\/\//i.test(t))return t;let n=s(e.API_BASE_URL),r=t.startsWith(`/`)?t:`/${t}`;return n.endsWith(`/api`)&&r.startsWith(`/api/`)&&(r=r.slice(4)),`${n}${r}`}function l(t,n){if(!n||Object.keys(n).length===0)return t;let r=globalThis.location?.origin??e.API_BASE_URL,i=new URL(t,r);return Object.entries(n).forEach(([e,t])=>{if(!(t==null||t===``)){if(Array.isArray(t)){t.forEach(t=>i.searchParams.append(e,t));return}i.searchParams.set(e,t)}}),i.toString()}function u(e){try{return globalThis.window?.[e]??null}catch{return null}}function d(){let t=u(`sessionStorage`),n=u(`localStorage`);return t?.getItem(e.TOKEN_STORAGE_KEY)||n?.getItem(e.TOKEN_STORAGE_KEY)||null}function f(t,{remember:n=!1}={}){let r=u(n?`localStorage`:`sessionStorage`),i=u(n?`sessionStorage`:`localStorage`);if(i?.removeItem(e.TOKEN_STORAGE_KEY),i?.removeItem(e.REMEMBER_STORAGE_KEY),!t){r?.removeItem(e.TOKEN_STORAGE_KEY),r?.removeItem(e.REMEMBER_STORAGE_KEY);return}r?.setItem(e.TOKEN_STORAGE_KEY,t),r?.setItem(e.REMEMBER_STORAGE_KEY,n?`1`:`0`)}function p(e){globalThis.window&&window.dispatchEvent(new CustomEvent(n,{detail:e}))}async function m(e){return e.status===204?null:(e.headers.get(`content-type`)||``).includes(r)?e.json():e.text()}async function ee(e,t=null){let n=t??await m(e).catch(()=>null),r=n?.error??{};return new a({code:r.code||`HTTP_${e.status}`,message:r.message||e.statusText||`Erro ao comunicar com a API.`,status:e.status,details:n})}async function h(e,t,{body:n=void 0,query:o=void 0,headers:s={},signal:u=void 0,credentials:d=`same-origin`}={}){let f=l(c(t),o),h=new Headers(s);h.has(`Accept`)||h.set(`Accept`,r),n!==void 0&&!h.has(`Content-Type`)&&h.set(`Content-Type`,r),i&&!h.has(`Authorization`)&&h.set(`Authorization`,`Bearer ${i}`);let g=await fetch(f,{method:e,headers:h,body:n===void 0?void 0:JSON.stringify(n),signal:u,credentials:d}).catch(e=>{throw new a({code:`NETWORK_ERROR`,message:`Nao foi possivel conectar com a API.`,status:0,details:e})}),_=await m(g).catch(()=>null);if(!g.ok){let e=await ee(g,_);throw g.status===401&&p(e),e}return _}var g={get(e,t={}){return h(`GET`,e,t)},post(e,t,n={}){return h(`POST`,e,{...n,body:t})},put(e,t,n={}){return h(`PUT`,e,{...n,body:t})},patch(e,t,n={}){return h(`PATCH`,e,{...n,body:t})},delete(e,t={}){return h(`DELETE`,e,t)},setAuthToken(e,{remember:t=!1,persist:n=!0}={}){i=e||null,n&&f(i,{remember:t})},getAuthToken(){return i},clearAuthToken(){i=null,f(null)},isApiError(e){return e instanceof a||o(e)&&`code`in e&&`status`in e},getBaseUrl(){return s(e.API_BASE_URL).replace(/\/api$/,``)}};function _(e){return{set(t,n){try{return e.setItem(t,JSON.stringify(n)),!0}catch{return console.warn(`[Storage] Falha ao salvar "${t}"`),!1}},get(t,n=null){try{let r=e.getItem(t);return r===null?n:JSON.parse(r)}catch{return n}},remove(t){try{e.removeItem(t)}catch{}},removeByPrefix(t){try{Object.keys(e).filter(e=>e.startsWith(t)).forEach(t=>e.removeItem(t))}catch{}},clear(){try{e.clear()}catch{}},has(t){try{return e.getItem(t)!==null}catch{return!1}}}}var v={..._(localStorage),session:_(sessionStorage)},y={isAuthenticated(){return!!g.getAuthToken()},getToken(){return g.getAuthToken()},persist(e,{remember:t=!1}={}){g.setAuthToken(e,{remember:t})},clear(){g.clearAuthToken()},isRemembered(){return v.get(e.REMEMBER_STORAGE_KEY)===`1`||v.session.get(e.REMEMBER_STORAGE_KEY)===`1`},setUser(e){(this.isRemembered()?v:v.session).set(`ef_user`,{id:e.id,name:e.name,email:e.email,company_name:e.company_name})},getUser(){return v.get(`ef_user`)||v.session.get(`ef_user`)||null},clearUser(){v.remove(`ef_user`),v.session.remove(`ef_user`)},destroy(){this.clear(),this.clearUser()}},b={async login({email:e,password:t,rememberMe:n=!1}={}){let r=await g.post(`/auth/login`,{email:e,password:t,remember_me:n});return r?.token&&g.setAuthToken(r.token,{remember:n}),r},async register(e){let t=await g.post(`/auth/register`,e);return t?.token&&g.setAuthToken(t.token,{remember:!1}),t},async forgotPassword({email:e}={}){return g.post(`/auth/forgot-password`,{email:e})},async resetPassword({token:e,email:t,password:n}={}){return g.post(`/auth/reset-password`,{token:e,email:t,password:n})},async logout(){try{return await g.post(`/auth/logout`,{})}finally{g.clearAuthToken()}},getToken(){return g.getAuthToken()},clearSession(){g.clearAuthToken()}},x=!1;async function te(){if(!x){x=!0;try{await b.logout()}catch{}finally{y.destroy(),D(),x=!1}window.Alpine?.store(`toast`)?.show(`Logout realizado.`,`info`),t.navigate(`/login`)}}var S=`ef_sidebar_collapsed`,ne=[{path:`/dashboard`,label:`Dashboard`,icon:`dashboard`},{path:`/transparency`,label:`Transparência`,icon:`transparency`},{path:`/devices`,label:`Dispositivos`,icon:`devices`},{path:`/alerts`,label:`Alertas`,icon:`alerts`},{path:`/goals`,label:`Metas`,icon:`goals`,hidden:!0},{path:`/financial`,label:`Financeiro`,icon:`financial`},{path:`/reports`,label:`Relatórios`,icon:`reports`},{path:`/settings`,label:`Configurações`,icon:`settings`}];function C(e){return{dashboard:`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg>`,transparency:`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>`,devices:`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>`,alerts:`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>`,goals:`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>`,financial:`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>`,reports:`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>`,settings:`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>`,swap:`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="17 1 21 5 17 9"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><polyline points="7 23 3 19 7 15"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/></svg>`,logout:`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>`,logo:`<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>`,sun:`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>`,moon:`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>`,menu:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="18" x2="21" y2="18"/></svg>`,close:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>`}[e]||``}var w=(()=>{let e=null,t=null,n=``;function r(){return y.getUser()||{}}function i(e=``){return e.trim().split(/\s+/).slice(0,2).map(e=>e[0]).join(``).toUpperCase()||`?`}function a(a){let o=r(),s=localStorage.getItem(S)===`true`;e=document.createElement(`div`),e.setAttribute(`x-data`,JSON.stringify({sidebarOpen:!1,collapsed:s,dropdownOpen:!1,darkMode:localStorage.getItem(`ef_theme`)===`dark`})),e.className=`flex h-screen overflow-hidden bg-gray-50 dark:bg-gray-900`;let c=ne.filter(e=>!e.hidden).map(e=>`
      <a href="#${e.path}"
         ...
         data-path="${e.path}">
        <span class="shrink-0">${C(e.icon)}</span>
      ...
      <aside :class="[sidebarOpen ? 'translate-x-0' : '-translate-x-full', collapsed && !sidebarOpen ? 'md:w-16' : 'md:w-60']"
        ...
        <div class="px-3 py-3 border-t border-gray-200 dark:border-gray-700 space-y-1">
          <a href="#/sectors/select" @click="if(window.innerWidth < 768) sidebarOpen = false" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white transition-colors">
            <span class="shrink-0">${C(`swap`)}</span>
            <span x-show="!collapsed || sidebarOpen" x-cloak>Trocar setor</span>
          </a>
          <button @click="collapsed = !collapsed; localStorage.setItem('${S}', collapsed)" class="hidden md:flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 w-full transition-colors">
        ...
        <header class="h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between px-4 shrink-0">
          ...
          <div class="flex items-center gap-2">
            ...
            <button @click="darkMode = !darkMode; localStorage.setItem('ef_theme', darkMode ? 'dark' : 'light'); document.documentElement.classList.toggle('dark', darkMode); document.documentElement.setAttribute('data-theme', darkMode ? 'dark' : 'light')"
              ...
              <span x-show="!darkMode">${C(`moon`)}</span>
              <span x-show="darkMode" x-cloak>${C(`sun`)}</span>
            </button>
            <!-- Avatar dropdown -->
            <div class="relative">
...
`,window.Alpine?.initTree(e)}function _e(n){n.data(`loginPage`,()=>({email:``,password:``,rememberMe:!1,loading:!1,demoLoading:!1,showPassword:!1,errors:{email:``,password:``},touched:{email:!1,password:!1},globalError:``,validateEmail(){return this.email.trim()?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(this.email.trim())?``:`E-mail inválido`:`Campo obrigatório`},validatePassword(){return this.password?``:`Campo obrigatório`},onBlur(e){this.touched[e]=!0,this.errors[e]=e===`email`?this.validateEmail():this.validatePassword()},onInput(e){this.touched[e]&&(this.errors[e]=e===`email`?this.validateEmail():this.validatePassword())},runAllValidations(){return this.touched.email=!0,this.touched.password=!0,this.errors.email=this.validateEmail(),this.errors.password=this.validatePassword(),!this.errors.email&&!this.errors.password},get hasErrors(){return!!(this.errors.email||this.errors.password)},async submit(){if(this.runAllValidations()){this.loading=!0,this.globalError=``;try{let e=await b.login({email:this.email.trim().toLowerCase(),password:this.password,rememberMe:this.rememberMe});e?.user&&y.setUser(e.user),t.navigate(`/sectors/select`)}catch(e){this.loading=!1,this._handleError(e)}}},get showDemo(){return e.DEMO_MODE},async loginDemo(){this.demoLoading=!0,this.globalError=``;try{let e=await b.login({email:`joao@technova.com.br`,password:`demo`,rememberMe:!0});e?.user&&y.setUser(e.user),t.navigate(`/sectors/select`)}catch{this.demoLoading=!1,n.store(`toast`)?.show(`Erro ao entrar no modo demo.`,`error`)}},_handleError(e){let t=e?.code||``;if(t===`INVALID_CREDENTIALS`||e?.status===401){this.globalError=`E-mail ou senha incorretos.`;return}if(t===`TOO_MANY_ATTEMPTS`||e?.status===429){this.globalError=`Muitas tentativas. Tente novamente em alguns minutos.`;return}if(t===`NETWORK_ERROR`){n.store(`toast`)?.show(`Sem conexão com o servidor.`,`error`,8e3);return}this.globalError=e?.message||`Ocorreu um erro. Tente novamente.`},darkMode:localStorage.getItem(`ef_theme`)===`dark`,toggleTheme(){this.darkMode=!this.darkMode;let e=this.darkMode?`dark`:`light`;document.documentElement.setAttribute(`data-theme`,e),document.documentElement.classList.toggle(`dark`,this.darkMode),localStorage.setItem(`ef_theme`,e)}}))}var F=!1;function ve(e){!F&&window.Alpine&&(_e(window.Alpine),F=!0),e.innerHTML=`
...
`,window.Alpine?.initTree(e)}function ye(e){e.data(`forgotPasswordPage`,()=>({email:``,emailError:``,touched:!1,loading:!1,sent:!1,validateEmail(){return this.email.trim()?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(this.email.trim())?``:`E-mail inválido`:`Campo obrigatório`},onBlur(){this.touched=!0,this.emailError=this.validateEmail()},onInput(){this.touched&&(this.emailError=this.validateEmail())},async submit(){if(this.touched=!0,this.emailError=this.validateEmail(),!this.emailError){this.loading=!0;try{await b.forgotPassword({email:this.email.trim().toLowerCase()})}catch(t){if(t?.code===`NETWORK_ERROR`){this.loading=!1,e.store(`toast`)?.show(`Sem conexão com o servidor.`,`error`,8e3);return}}this.loading=!1,this.sent=!0}},darkMode:localStorage.getItem(`ef_theme`)===`dark`,toggleTheme(){this.darkMode=!this.darkMode;let e=this.darkMode?`dark`:`light`;document.documentElement.setAttribute(`data-theme`,e),document.documentElement.classList.toggle(`dark`,this.darkMode),localStorage.setItem(`ef_theme`,e)}}))}var I=!1;function be(e){!I&&window.Alpine&&(ye(window.Alpine),I=!0),e.innerHTML=`
...
`,window.Alpine?.initTree(e)}function xe(e){e.data(`resetPasswordPage`,()=>({password:``,passwordConfirm:``,showPassword:!1,showPasswordConfirm:!1,loading:!1,globalError:``,tokenExpired:!1,token:``,email:``,errors:{password:``,passwordConfirm:``},touched:{password:!1,passwordConfirm:!1},init(){let e=(window.location.hash||``).split(`?`)[1]||``,t=new URLSearchParams(e);this.token=t.get(`token`)||``,this.email=t.get(`email`)||``,(!this.token||!this.email)&&(this.tokenExpired=!0)},_validatePassword(){return this.password?this.password.length<8?`Mínimo 8 caracteres`:/[a-zA-Z]/.test(this.password)?/[0-9]/.test(this.password)?``:`Deve conter ao menos um número`:`Deve conter ao menos uma letra`:`Campo obrigatório`},_validateConfirm(){return this.passwordConfirm?this.password===this.passwordConfirm?``:`Senhas não conferem`:`Campo obrigatório`},onBlur(e){this.touched[e]=!0,this.errors[e]=e===`password`?this._validatePassword():this._validateConfirm()},onInput(e){this.touched[e]&&(this.errors[e]=e===`password`?this._validatePassword():this._validateConfirm(),e===`password`&&this.touched.passwordConfirm&&(this.errors.passwordConfirm=this._validateConfirm()))},async submit(){if(this.touched.password=!0,this.touched.passwordConfirm=!0,this.errors.password=this._validatePassword(),this.errors.passwordConfirm=this._validateConfirm(),!(this.errors.password||this.errors.passwordConfirm)){this.loading=!0,this.globalError=``;try{await b.resetPassword({token:this.token,email:this.email,password:this.password}),e.store(`toast`)?.show(`Senha redefinida com sucesso. Faça login.`,`success`,7e3),t.navigate(`/login`)}catch(t){this.loading=!1;let n=t?.code||``;if(n===`AUTH_TOKEN_INVALID`||n===`AUTH_TOKEN_EXPIRED`){this.tokenExpired=!0;return}if(n===`NETWORK_ERROR`){e.store(`toast`)?.show(`Sem conexão com o servidor.`,`error`,8e3);return}this.globalError=t?.message||`Ocorreu um erro. Tente novamente.`}}},darkMode:localStorage.getItem(`ef_theme`)===`dark`,toggleTheme(){this.darkMode=!this.darkMode;let e=this.darkMode?`dark`:`light`;document.documentElement.setAttribute(`data-theme`,e),document.documentElement.classList.toggle(`dark`,this.darkMode),localStorage.setItem(`ef_theme`,e)}}))}var L=!1;function Se(e){!L&&window.Alpine&&(xe(window.Alpine),L=!0),e.innerHTML=`
...
`,window.Alpine?.initTree(e)}var R=null,z=0,Ce=5e3;async function B(){let e=Date.now();if(R&&e-z<Ce)return R;let t=await g.get(`/api/dashboard/public`);if(t.success&&t.data)return R=t.data,z=e,t.data;throw Error(`Failed to load dashboard data`)}var V={async getPublicData(){return B()},async getAuthenticatedDashboardData(){let e=await g.get(`/api/dashboard`);return e?.data||e},async getKpis(){let e=await B(),t=0,n=0,r=e.latest_readings||{};for(let e in r)t+=r[e].energia_kwh||0,n+=r[e].potencia||0;let i=t*.85;return{month_kwh:t,monthly_cost:i,active_devices:e.active_devices||0,total_devices:e.total_devices||0,open_alerts:0,consumption_variation:0,cost_variation:0,total_potencia:n}},async getConsumptionChart({from:e,to:t,granularity:n}={}){return g.get(`/api/dashboard/consumption`,{query:{from:e,to:t,granularity:n}})},async getTopSectors({from:e,to:t,limit:n=5}={}){let r=(await B()).setor_data||{};return{sectors:Object.entries(r).map(([e,t])=>({name:e,total_kwh:t.total_energia_kwh||0,consumo:t.total_energia_kwh||0,potencia:t.total_potencia||0})).sort((e,t)=>t.total_kwh-e.total_kwh).slice(0,n)}},async getFirebaseDevices(){let e=await B(),t=e.latest_readings||{},n=e.devices_status||{};return Object.entries(t).map(([e,t])=>({id:e,firebase_id:e,name:t.nome||e,potencia:t.potencia||0,energia_kwh:t.energia_kwh||0,timestamp:t.timestamp||null,status:n[e]?.active?`online`:`offline`,sector:e}))},async getFirebaseSectors(){let e=(await B()).latest_readings||{};return Object.entries(e).map(([e,t])=>({id:e,name:t.nome||e,potencia:t.potencia||0,energia_kwh:t.energia_kwh||0,timestamp:t.timestamp||null}))},async getRecentAlerts({limit:e=5}={}){return g.get(`/api/alerts`,{query:{status:`open`,limit:e,sort:`-created_at`}})},async getOffHoursAlerts({from:e,to:t,limit:n=5}={}){return g.get(`/api/alerts`,{query:{type:`off_hours`,from:e,to:t,limit:n,sort:`-created_at`}})},async getNightWasteAlerts({from:e,to:t,limit:n=5}={}){return g.get(`/api/alerts`,{query:{type:`night_waste`,from:e,to:t,limit:n,sort:`-created_at`}})},async getOpenAlertsCount(){return g.get(`/api/alerts/count`,{query:{status:`open`}})}},H=`pt-BR`;function we(e,t=2){return e==null||isNaN(e)?`—`:`${new Intl.NumberFormat(H,{minimumFractionDigits:t,maximumFractionDigits:t}).format(e)} kWh`}function Te(e){return e==null||isNaN(e)?`—`:new Intl.NumberFormat(H,{style:`currency`,currency:`BRL`}).format(e)}var Ee=`lf_selected_sector`;function De(e){e.data(`dashboardPage`,()=>({kpis:{consumption:{value:`—`,unit:`kWh`,loading:!0},cost:{value:`—`,unit:`R$`,loading:!0},alerts:{value:`0`,loading:!1},devices:{value:`—`,loading:!0}},accumulatedKwh:0,previousReadings:{},selectedSector:null,get userName(){return y.getUser()?.name||``},get realtimePower(){return e.store(`realtime`)?.totalPower??null},lastUpdate:null,_interval:null,init(){e.store(`realtime`)?.startListening();try{let e=localStorage.getItem(Ee);e&&(this.selectedSector=JSON.parse(e))}catch{}this.loadKpis(),this._interval=setInterval(()=>this.loadKpis(),1e4)},destroy(){this._interval&&clearInterval(this._interval)},async loadKpis(){try{let[t,n]=await Promise.all([V.getPublicData(),A.getCount({status:`open`}).catch(()=>({count:0}))]),r=t?.latest_readings||{},i=t?.total_devices||0,a=!1,o=null;if(this.selectedSector){for(let[e,t]of Object.entries(r))if(e===this.selectedSector.id||t.nome===this.selectedSector.name){o=t,a=!0;break}}let s=!this.previousReadings||Object.keys(this.previousReadings).length===0;s&&(this.previousReadings={_initialized:!0});let c=t?.consumption_cards||{},l=0,u=0;if(this.selectedSector){let e=c[this.selectedSector.id];e&&(l=e.kwh||0,u=e.cost||0)}else for(let e of Object.values(c))l+=e.kwh||0,u+=e.cost||0;this.accumulatedKwh=l,this.selectedSector&&a&&(this.selectedSector={...this.selectedSector,potencia:o.potencia||0,energia_kwh:o.energia_kwh||0});let d=Math.floor(this.accumulatedKwh*1e3)/1e3;this.kpis.consumption={value:we(d,3).replace(` kWh`,``),unit:`KWh`,loading:!1},this.kpis.cost={value:Te(u).replace(`R$\xA0`,``).replace(`R$ `,``),unit:`R$`,loading:!1},this.kpis.devices={value:String(i),loading:!1};let f=parseInt(this.kpis.alerts.value,10)||0,p=n?.count??0,m=p>f;if(this.kpis.alerts={value:String(p),loading:!1,increased:m},m&&!s){let t=p-f,n=t===1?`⚠️ Novo alerta recebido!`:`⚠️ ${t} novos alertas recebidos!`;e.store(`toast`)?.show(n,`warning`,5e3)}this.lastUpdate=new Date}catch{Object.keys(this.kpis).forEach(e=>{this.kpis[e]={...this.kpis[e],value:`—`,loading:!1}})}},goTo(e){t.navigate(e)},changeSector(){t.navigate(`/sectors/select`)},formatSectorEnergy(e){if(e==null)return`—`;let t=Math.floor(e*1e3)/1e3;return new Intl.NumberFormat(`pt-BR`,{minimumFractionDigits:3,maximumFractionDigits:3}).format(t)+` KWh`},formatPower(e){return e==null?`—`:e>=1e3?(e/1e3).toFixed(2)+` W`:e.toFixed(1)+` W`},formatTime(){return this.lastUpdate?this.lastUpdate.toLocaleTimeString(`pt-BR`,{hour:`2-digit`,minute:`2-digit`,second:`2-digit`}):``}}))}var U=!1;function Oe(e){!U&&window.Alpine&&(De(window.Alpine),U=!0),e.innerHTML=ke(),window.Alpine?.initTree(e)}function ke(){return`
<div x-data="dashboardPage" @beforeunload.window="destroy()" class="space-y-8 p-6">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
    ${W(`consumption`,`Consumo`,`KWh`,`bolt`,`#/financial`)}
    ${W(`cost`,`Custo`,`R$`,`dollar`,`#/financial`)}
    ${W(`alerts`,`Alertas`,``,`bell`,`#/alerts`)}
    ${W(`devices`,`Dispositivos`,``,`device`,`#/devices`)}
  </div>
  ...
  <section class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
      ${G(`Transparência`,`#/transparency`,`bolt`)}
      ${G(`Trocar setor`,`#/sectors/select`,`swap`)}
      ${G(`Dispositivos`,`#/devices`,`device`)}
      ${G(`Alertas`,`#/alerts`,`bell`)}
    </div>
  </section>

</div>
`}function W(e,t,n,r,i){let a={bolt:`<path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/>`,dollar:`<line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>`,bell:`<path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/>`,device:`<rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/>`},o={consumption:{bg:`bg-blue-50 dark:bg-blue-900/20`,icon:`text-blue-500`,border:`border-blue-100 dark:border-blue-800`},cost:{bg:`bg-emerald-50 dark:bg-emerald-900/20`,icon:`text-emerald-500`,border:`border-emerald-100 dark:border-emerald-800`},alerts:{bg:`bg-amber-50 dark:bg-amber-900/20`,icon:`text-amber-500`,border:`border-amber-100 dark:border-amber-800`},devices:{bg:`bg-purple-50 dark:bg-purple-900/20`,icon:`text-purple-500`,border:`border-purple-100 dark:border-purple-800`}}[e],s=e===`alerts`;return`
    <a href="${i}" :class="{ 'ring-2 ring-amber-400 ring-offset-2 dark:ring-offset-gray-900': ${s} && kpis.${e}.increased }"
      ...
      <span x-show="kpis.${e}.increased" x-cloak
      ...
      <div x-show="!kpis.${e}.loading" x-cloak class="flex items-baseline gap-2">
        <span :class="${s} && kpis.${e}.value !== '0' ? 'text-amber-500' : 'text-gray-900 dark:text-white'"
              class="text-3xl font-bold tracking-tight" x-text="kpis.${e}.value"></span>
  ...
  `}function K(e={}){let t={name:e.name?.trim(),description:e.description?.trim()||null};return e.threshold_yellow!==``&&e.threshold_yellow!=null&&(t.threshold_yellow=Number(e.threshold_yellow)),e.threshold_red!==``&&e.threshold_red!=null&&(t.threshold_red=Number(e.threshold_red)),t}var q={async list({active:e=null,search:t=``}={}){return g.get(`/api/sectors`,{query:{active:e,search:t?.trim()}})},async create(e){let t=K(e),n=await g.post(`/api/sectors`,t),r=n?.sector;return r?.id&&(t.threshold_yellow!=null||t.threshold_red!=null)?this.update(r.id,t):n},async update(e,t){return g.put(`/api/sectors/${encodeURIComponent(e)}`,K(t))},async deactivate(e){return g.delete(`/api/sectors/${encodeURIComponent(e)}`)}};function J(e={},{editing:t=!1}={}){let n={name:e.name?.trim(),type:e.type,sector_id:e.sector_id,installed_at:e.installed_at||null,overload_threshold_w:e.overload_threshold_w===``||e.overload_threshold_w==null?null:Number(e.overload_threshold_w),is_critical:!!e.is_critical};return t||(n.device_id=e.device_id?.trim()),n}var Y={async list({sector_id:e=``,type:t=``,active:n=null}={}){return g.get(`/api/devices`,{query:{sector_id:e,type:t,active:n}})},async get(e){return g.get(`/api/devices/${encodeURIComponent(e)}`)},async create(e){return g.post(`/api/devices`,J(e))},async update(e,t){return g.put(`/api/devices/${encodeURIComponent(e)}`,J(t,{editing:!0}))},async deactivate(e){return g.delete(`/api/devices/${encodeURIComponent(e)}`)},async getReadings(e,{from:t,to:n,granularity:r}={}){return g.get(`/api/devices/${encodeURIComponent(e)}/readings`,{query:{from:t,to:n,granularity:r}})},async getAnomalies(e,{from:t,to:n}={}){return g.get(`/api/devices/${encodeURIComponent(e)}/anomalies`,{query:{from:t,to:n}})},async getMaintenance(e){return g.get(`/api/devices/${encodeURIComponent(e)}/maintenance`)},async addMaintenance(e,t){return g.post(`/api/devices/${encodeURIComponent(e)}/maintenance`,t)}};function Ae(e){e.data(`sectorsPage`,()=>({sectors:[],devices:[],loading:!0,error:null,search:``,showInactive:!1,modalOpen:!1,modalTitle:``,editing:null,form:{name:``,description:``,threshold_yellow:``,threshold_red:``},formErrors:{name:``,threshold_yellow:``,threshold_red:``},saving:!1,confirmOpen:!1,confirmSector:null,deactivating:!1,async init(){await this.load()},async load(){this.loading=!0,this.error=null;try{let[e,t]=await Promise.all([q.list({active:this.showInactive?null:!0}),Y.list()]);this.sectors=e?.sectors||e?.data||[],this.devices=t?.devices||t?.data||[]}catch(e){this.error=e?.message||`Erro ao carregar setores.`}finally{this.loading=!1}},get filtered(){let e=this.search.trim().toLowerCase();return e?this.sectors.filter(t=>t.name.toLowerCase().includes(e)):this.sectors},deviceCount(e){return this.devices.filter(t=>t.sector_id===e&&t.active).length},openNew(){this.editing=null,this.modalTitle=`Novo setor`,this.form={name:``,description:``,threshold_yellow:``,threshold_red:``},this.formErrors={name:``,threshold_yellow:``,threshold_red:``},this.modalOpen=!0},openEdit(e){this.editing=e,this.modalTitle=`Editar setor`,this.form={name:e.name||``,description:e.description||``,threshold_yellow:e.threshold_yellow??``,threshold_red:e.threshold_red??``},this.formErrors={name:``,threshold_yellow:``,threshold_red:``},this.modalOpen=!0},validateForm(){let e=!0;this.formErrors={name:``,threshold_yellow:``,threshold_red:``},this.form.name.trim()||(this.formErrors.name=`Campo obrigatório`,e=!1);let t=this.form.threshold_yellow===``?null:Number(this.form.threshold_yellow),n=this.form.threshold_red===``?null:Number(this.form.threshold_red);return t!==null&&(isNaN(t)||t<=0)&&(this.formErrors.threshold_yellow=`Valor inválido`,e=!1),n!==null&&(isNaN(n)||n<=0)&&(this.formErrors.threshold_red=`Valor inválido`,e=!1),t!==null&&n!==null&&t>=n&&(this.formErrors.threshold_red=`Deve ser maior que o amarelo`,e=!1),e},async saveForm(){if(this.validateForm()){this.saving=!0;try{let t={name:this.form.name.trim(),description:this.form.description.trim(),threshold_yellow:this.form.threshold_yellow||null,threshold_red:this.form.threshold_red||null};this.editing?await q.update(this.editing.id,t):await q.create(t),e.store(`toast`)?.show(`Setor salvo com sucesso.`,`success`),this.modalOpen=!1,await this.load()}catch(t){t?.code===`SECTOR_NAME_EXISTS`||t?.code===`SECTOR_NAME_TAKEN`?this.formErrors.name=`Este nome já está em uso.`:e.store(`toast`)?.show(t?.message||`Erro ao salvar.`,`error`)}finally{this.saving=!1}}},askDeactivate(e){this.confirmSector=e,this.confirmOpen=!0},async confirmDeactivate(){if(this.confirmSector){this.deactivating=!0;try{await q.deactivate(this.confirmSector.id),e.store(`toast`)?.show(`Setor desativado.`,`success`),this.confirmOpen=!1,await this.load()}catch(t){e.store(`toast`)?.show(t?.message||`Erro ao desativar.`,`error`)}finally{this.deactivating=!1}}},toggleInactive(){this.showInactive=!this.showInactive,this.load()}}))}var X=!1;function je(e){!X&&window.Alpine&&(Ae(window.Alpine),X=!0),e.innerHTML=`
...
`,window.Alpine?.initTree(e)}function Me(e){e.data(`devicesPage`,()=>({devices:[],loading:!0,error:null,search:``,filterSector:``,async init(){await this.load()},async load(){this.loading=!0,this.error=null;try{this.devices=await V.getFirebaseDevices()}catch(e){this.error=e?.message||`Erro ao carregar dispositivos.`}finally{this.loading=!1}},get sectorOptions(){return[...new Set(this.devices.map(e=>e.name))].sort()},get filtered(){let e=this.devices,t=this.search.trim().toLowerCase();return t&&(e=e.filter(e=>e.name.toLowerCase().includes(t)||e.sector.toLowerCase().includes(t))),this.filterSector&&(e=e.filter(e=>e.name===this.filterSector)),e},statusBadge(e){return e.status===`online`?{text:`Online`,class:`bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400`}:{text:`Offline`,class:`bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400`}},formatPower(e){return e==null?`—`:e>=1e3?(e/1e3).toFixed(1)+` kW`:e.toFixed(1)+` W`},formatEnergy(e){return e==null?`—`:e.toFixed(3)+` KWh`}}))}var Ne=!1;function Pe(e){!Ne&&window.Alpine&&(Me(window.Alpine),Ne=!0),e.innerHTML=`
...
`,window.Alpine?.initTree(e)}function Fe(e){e.data(`deviceDetailPage`,()=>({deviceId:null,device:null,loading:!0,error:null,activeTab:`readings`,readings:[],readingsLoading:!1,anomalies:[],anomaliesLoading:!1,maintenance:[],maintenanceLoading:!1,modalOpen:!1,maintForm:{date:``,type:``,notes:``},maintSaving:!1,async init(){let e=window.location.hash.match(/\/devices\/(\d+)/);if(this.deviceId=e?Number(e[1]):null,!this.deviceId){this.error=`Dispositivo não encontrado.`,this.loading=!1;return}await this.loadDevice()},async loadDevice(){this.loading=!0,this.error=null;try{this.device=await Y.get(this.deviceId),await this.loadTab()}catch(e){this.error=e?.message||`Erro ao carregar dispositivo.`}finally{this.loading=!1}},async switchTab(e){this.activeTab=e,await this.loadTab()},async loadTab(){this.activeTab===`readings`?await this.loadReadings():this.activeTab===`anomalies`?await this.loadAnomalies():this.activeTab===`maintenance`&&await this.loadMaintenance()},async loadReadings(){this.readingsLoading=!0;try{let e=await Y.getReadings(this.deviceId,{});this.readings=e?.values?.map((t,n)=>({label:e.labels?.[n]||``,value:t,isAnomaly:(e.anomalies||[]).includes(n)}))||[]}catch{this.readings=[]}finally{this.readingsLoading=!1}},async loadAnomalies(){this.anomaliesLoading=!0;try{let e=await Y.getAnomalies(this.deviceId);this.anomalies=e?.anomalies||e?.data||e||[]}catch{this.anomalies=[]}finally{this.anomaliesLoading=!1}},async loadMaintenance(){this.maintenanceLoading=!0;try{let e=await Y.getMaintenance(this.deviceId);this.maintenance=e?.records||e?.data||e||[]}catch{this.maintenance=[]}finally{this.maintenanceLoading=!1}},openMaintenanceModal(){this.maintForm={date:``,type:``,notes:``},this.modalOpen=!0},async saveMaintenance(){if(!(!this.maintForm.date||!this.maintForm.type)){this.maintSaving=!0;try{await Y.addMaintenance(this.deviceId,this.maintForm),e.store(`toast`)?.show(`Manutenção registrada.`,`success`),this.modalOpen=!1,await this.loadMaintenance()}catch(t){e.store(`toast`)?.show(t?.message||`Erro ao salvar.`,`error`)}finally{this.maintSaving=!1}}},formatDate(e){return e?new Date(e).toLocaleDateString(`pt-BR`):`—`},formatDateTime(e){return e?new Date(e).toLocaleString(`pt-BR`):`—`},deviationPercent(e){return e.expected_value?Math.round((e.actual_value-e.expected_value)/e.expected_value*100):0},goBack(){t.navigate(`/devices`)}}))}var Ie=!1;function Le(e){!Ie&&window.Alpine&&(Fe(window.Alpine),Ie=!0),e.innerHTML=`
...
`,window.Alpine?.initTree(e)}var Ve=[{key:`monday`,label:`Segunda`},{key:`tuesday`,label:`Terça`},{key:`wednesday`,label:`Quarta`},{key:`thursday`,label:`Quinta`},{key:`friday`,label:`Sexta`},{key:`saturday`,label:`Sábado`},{key:`sunday`,label:`Domingo`}];function He(e){e.data(`settingsPage`,()=>({days:Ve.map(e=>({...e,enabled:e.key!==`saturday`&&e.key!==`sunday`,start:`08:00`,end:`18:00`})),loading:!0,saving:!1,error:null,sectorAverages:[],loadingAverages:!0,savingAverages:!1,async init(){await Promise.all([this.load(),this.loadAverages()])},async load(){this.loading=!0,this.error=null;try{let e=await g.get(`/api/business-hours`),t=e?.data||e||{};t.days&&Array.isArray(t.days)&&(this.days=Ve.map(e=>{let n=t.days.find(t=>t.day===e.key)||{};return{...e,enabled:n.enabled!==!1,start:n.start||`08:00`,end:n.end||`18:00`}}))}catch(e){this.error=e?.message||`Erro ao carregar configurações.`}finally{this.loading=!1}},async save(){this.saving=!0;try{let t={days:this.days.map(e=>({day:e.key,enabled:e.enabled,start:e.start,end:e.end}))};await g.put(`/api/business-hours`,t),e.store(`toast`)?.show(`Configurações salvas.`,`success`)}catch(t){e.store(`toast`)?.show(t?.message||`Erro ao salvar.`,`error`)}finally{this.saving=!1}},async loadAverages(){this.loadingAverages=!0;try{let e=(await V.getAuthenticatedDashboardData())?.latest_readings||{},t=[];try{t=(await g.get(`/api/sector-averages`))?.averages||[]}catch{}this.sectorAverages=Object.entries(e).map(([e,n])=>{let r=e,i=n.nome||e,a=t.find(e=>e.sector_name===r&&e.is_manual_override),o=t.find(e=>e.sector_name===r&&!e.is_manual_override);return{sector_name:r,sector_label:i,average_kwh:a?.average_kwh||o?.average_kwh||0,is_manual_override:!!a,auto_average:o?.average_kwh||0}})}catch(e){console.warn(`Erro ao carregar médias:`,e)}finally{this.loadingAverages=!1}},async saveAverages(){this.savingAverages=!0;try{let t={averages:this.sectorAverages.map(e=>({sector_name:e.sector_name,average_kwh:parseFloat(e.average_kwh)||0,is_manual_override:e.is_manual_override}))};await g.put(`/api/sector-averages`,t),e.store(`toast`)?.show(`Médias de consumo salvas.`,`success`)}catch(t){e.store(`toast`)?.show(t?.message||`Erro ao salvar médias.`,`error`)}finally{this.savingAverages=!1}},formatNumber(e){return e==null||e===0?`—`:Number(e).toLocaleString(`pt-BR`,{minimumFractionDigits:4,maximumFractionDigits:4})}}))}var Ue=!1;function We(e){!Ue&&window.Alpine&&(He(window.Alpine),Ue=!0),e.innerHTML=`
...
`,window.Alpine?.initTree(e)}function Je(e){e.data(`alertsPage`,()=>({alerts:[],loading:!0,error:null,filterType:``,filterSeverity:``,filterStatus:`open`,pollInterval:null,async init(){let e=window.location.hash;if(e.includes(`type=`)){let t=e.match(/type=([^&]+)/);t&&(this.filterType=t[1])}await this.load(!0),this.pollInterval=setInterval(async()=>{if(!document.querySelector(`[x-data="alertsPage"]`)){clearInterval(this.pollInterval);return}await this.load(!1)},1e4)},destroy(){this.pollInterval&&clearInterval(this.pollInterval)},async load(e=!0){e&&(this.loading=!0),this.error=null;try{let e={sort:`-created_at`,limit:50};this.filterType&&(e.type=this.filterType),this.filterSeverity&&(e.severity=this.filterSeverity),this.filterStatus&&(e.status=this.filterStatus);let t=await A.list(e);this.alerts=t?.data||t?.alerts||t||[],await this.checkNewNotifications()}catch(t){e?this.error=t?.message||`Erro ao carregar alertas.`:console.error(`Erro ao atualizar alertas em background:`,t)}finally{e&&(this.loading=!1)}},async checkNewNotifications(){try{let e=`lf_notified_alerts_${y.getUser()?.id||`guest`}`,t=await A.list({sort:`-created_at`,limit:50}),n=t?.data||t?.alerts||t||[],r=JSON.parse(localStorage.getItem(e)||`null`);if(r===null){r=n.map(e=>e.id),localStorage.setItem(e,JSON.stringify(r));return}let i=!1;for(let e of n)if(e.status===`open`&&!r.includes(e.id))try{await A.notify(e.id),r.push(e.id),i=!0}catch(t){console.error(`Erro ao disparar e-mail de alerta:`,e.id,t)}else r.includes(e.id)||(r.push(e.id),i=!0);i&&localStorage.setItem(e,JSON.stringify(r))}catch(e){console.error(`Erro no fluxo de notificação de e-mails:`,e)}},onFilterChange(){this.load(!0)},severityBadge(e){let t={critical:{text:`Crítico`,class:`bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400`},high:{text:`Alto`,class:`bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400`},medium:{text:`Médio`,class:`bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400`},low:{text:`Baixo`,class:`bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400`}};return t[e]||t.medium},statusBadge(e){let t={open:{text:`Aberto`,class:`bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400`},acknowledged:{text:`Reconhecido`,class:`bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400`},resolved:{text:`Resolvido`,class:`bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400`}};return t[e]||t.open},typeLabel(e){return{overload:`Sobrecarga`,off_hours:`Fora de horário`,night_waste:`Noturno`,anomaly:`Anomalia`,goal:`Meta`,above_average:`Acima da média`}[e]||e},formatDate(e){return e?new Date(e).toLocaleDateString(`pt-BR`,{day:`2-digit`,month:`2-digit`,hour:`2-digit`,minute:`2-digit`}):``},async acknowledge(t){try{await A.acknowledge(t.id),t.status=`acknowledged`,e.store(`toast`)?.show(`Alerta reconhecido.`,`success`)}catch{e.store(`toast`)?.show(`Erro ao reconhecer.`,`error`)}},async resolve(t){try{await A.resolve(t.id),t.status=`resolved`,e.store(`toast`)?.show(`Alerta resolvido.`,`success`)}catch{e.store(`toast`)?.show(`Erro ao resolver.`,`error`)}}}))}var Ye=!1;function Xe(e){!Ye&&window.Alpine&&(Je(window.Alpine),Ye=!0),e.innerHTML=`
...
`,window.Alpine?.initTree(e)}var Ze=`lf_selected_sector`;function Qe(e){e.data(`financialPage`,()=>({summary:null,ranking:[],loading:!0,error:null,selectedSector:null,async init(){try{let e=localStorage.getItem(Ze);e&&(this.selectedSector=JSON.parse(e))}catch{}await this.load()},async load(){this.loading=!0,this.error=null;try{let e=await V.getPublicData(),t=e?.latest_readings||{},n=e?.consumption_cards||{},r=0,i=0;for(let e of Object.values(n))r+=e.kwh||0,i+=e.cost||0;this.summary={total_kwh:r,total_cost:i},this.ranking=Object.entries(t).map(([e,t])=>{let r=n[e];return{name:t.nome,cost:r&&r.cost||0}}).sort((e,t)=>t.cost-e.cost),this.ranking.length===0&&(this.ranking=[{name:`Equipamentos`,cost:1540.5},{name:`Refrigeração`,cost:1200},{name:`Iluminação`,cost:850.2},{name:`Escritório`,cost:450}])}catch(e){this.error=e?.message||`Erro ao carregar dados financeiros.`}finally{this.loading=!1}},formatCurrency(e){return e==null?`R$ 0,00`:`R$ `+Number(e).toLocaleString(`pt-BR`,{minimumFractionDigits:2,maximumFractionDigits:2})}}))}var Q=!1;function $e(e){!Q&&window.Alpine&&(Qe(window.Alpine),Q=!0),e.innerHTML=`
...
`,window.Alpine?.initTree(e)}function et(e){e.data(`tariffsPage`,()=>({tariffs:[],loading:!0,error:null,modalOpen:!1,editing:null,form:{name:``,type:`conventional`,value_kwh:``,flag_color:`green`,active:!0},formErrors:{},saving:!1,async init(){await this.load()},async load(){this.loading=!0,this.error=null;try{let e=await g.get(`/api/tariffs`);this.tariffs=e?.data||e||[]}catch(e){this.error=e?.message||`Erro ao carregar tarifas.`}finally{this.loading=!1}},flagLabel(e){return{green:`Verde`,yellow:`Amarela`,red1:`Vermelha 1`,red2:`Vermelha 2`}[e]||e},flagClass(e){let t={green:`bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400`,yellow:`bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400`,red1:`bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400`,red2:`bg-red-200 text-red-800 dark:bg-red-900/40 dark:text-red-300`};return t[e]||t.green},openNew(){this.editing=null,this.form={name:``,type:`conventional`,value_kwh:``,flag_color:`green`,active:!0},this.formErrors={},this.modalOpen=!0},openEdit(e){this.editing=e,this.form={name:e.name,type:e.type||`conventional`,value_kwh:e.value_kwh,flag_color:e.flag_color||`green`,active:e.active},this.formErrors={},this.modalOpen=!0},async saveForm(){if(this.formErrors={},!this.form.name.trim()){this.formErrors.name=`Campo obrigatório`;return}if(!this.form.value_kwh||Number(this.form.value_kwh)<=0){this.formErrors.value_kwh=`Valor inválido`;return}this.saving=!0;try{let t={...this.form,value_kwh:Number(this.form.value_kwh)};this.editing?await g.put(`/api/tariffs/${this.editing.id}`,t):await g.post(`/api/tariffs`,t),e.store(`toast`)?.show(`Tarifa salva.`,`success`),this.modalOpen=!1,await this.load()}catch(t){e.store(`toast`)?.show(t?.message||`Erro ao salvar.`,`error`)}finally{this.saving=!1}},async deleteTariff(t){if(confirm(`Remover esta tarifa?`))try{await g.delete(`/api/tariffs/${t.id}`),e.store(`toast`)?.show(`Tarifa removida.`,`success`),await this.load()}catch(t){e.store(`toast`)?.show(t?.message||`Erro.`,`error`)}}}))}var tt=!1;function nt(e){!tt&&window.Alpine&&(et(window.Alpine),tt=!0),e.innerHTML=`
...
`,window.Alpine?.initTree(e)}var rt=`lf_selected_sector`;function it(e){e.data(`sectorSelectPage`,()=>({sectors:[],loading:!0,error:!1,get userName(){return y.getUser()?.name||``},async init(){await this.load()},async load(){this.loading=!0,this.error=!1;try{this.sectors=await V.getFirebaseSectors()}catch{this.error=!0}finally{this.loading=!1}},selectSector(e){try{localStorage.setItem(rt,JSON.stringify({id:e.id,name:e.name,potencia:e.potencia,energia_kwh:e.energia_kwh}))}catch{}t.navigate(`/dashboard`)},formatPower(e){return e==null?`—`:e>=1e3?(e/1e3).toFixed(1)+` kW`:e.toFixed(1)+` W`},formatEnergy(e){return e==null?`—`:e.toFixed(3)+` KWh`}}))}var at=!1;function ot(e){!at&&window.Alpine&&(it(window.Alpine),at=!0),e.innerHTML=`
...
`,window.Alpine?.initTree(e)}function st(e){e.data(`sectorDashboardPage`,()=>({sectorId:null,sector:null,devices:[],alerts:[],consumption:0,loading:!0,error:null,async init(){let e=window.location.hash.match(/\/sectors\/(\d+)/);if(this.sectorId=e?Number(e[1]):null,!this.sectorId){this.error=`Setor não encontrado.`,this.loading=!1;return}await this.load()},async load(){this.loading=!0,this.error=null;try{let[e,t,n,r]=await Promise.all([q.list({active:!0}),Y.list(),A.list({status:`open`,limit:5}),g.get(`/api/consumption/by-sector`)]),i=e?.sectors||e?.data||[];if(this.sector=i.find(e=>e.id===this.sectorId),!this.sector){this.error=`Setor não encontrado.`;return}this.devices=(t?.devices||t?.data||[]).filter(e=>e.sector_id===this.sectorId),this.alerts=(n?.data||n?.alerts||[]).filter(e=>e.sector_id===this.sectorId||e.sector?.id===this.sectorId).slice(0,5);let a=(r?.data||r||[]).find(e=>e.sector_id===this.sectorId||e.name===this.sector.name);this.consumption=a?.total_kwh||0}catch(e){this.error=e?.message||`Erro ao carregar dados.`}finally{this.loading=!1}},goBack(){t.navigate(`/sectors/select`)},goDevices(){t.navigate(`/devices`)},goAlerts(){t.navigate(`/alerts`)}}))}var ct=!1;function lt(e){!ct&&window.Alpine&&(st(window.Alpine),ct=!0),e.innerHTML=`
...
`,window.Alpine?.initTree(e)}function ut(e){e.data(`reportsPage`,()=>({sectors:[],selectedSector:``,dateFrom:``,dateTo:``,loading:!0,generating:!1,previewing:!1,previewData:null,error:null,async init(){let e=new Date;this.dateTo=e.toISOString().split(`T`)[0],this.dateFrom=new Date(e.getFullYear(),e.getMonth(),1).toISOString().split(`T`)[0],await this.loadSectors()},async loadSectors(){this.loading=!0,this.error=null;try{let e=(await V.getPublicData())?.latest_readings||{};this.sectors=Object.entries(e).map(([e,t])=>({id:e,name:t.nome||e})),this.sectors.length>0&&!this.selectedSector&&(this.selectedSector=this.sectors[0].id)}catch(e){this.error=e?.message||`Erro ao carregar setores.`}finally{this.loading=!1}},get selectedSectorLabel(){let e=this.sectors.find(e=>e.id===this.selectedSector);return e?e.name:this.selectedSector},get isFormValid(){return this.selectedSector&&this.dateFrom&&this.dateTo&&this.dateFrom<=this.dateTo},async preview(){if(this.isFormValid){this.previewing=!0,this.previewData=null,this.error=null;try{let e=await g.get(`/api/reports/consumption-data`,{query:{sector_name:this.selectedSector,date_from:this.dateFrom,date_to:this.dateTo}});this.previewData=e}catch(e){this.error=e?.message||`Erro ao carregar dados de prévia.`}finally{this.previewing=!1}}},async generatePdf(){if(this.isFormValid){this.generating=!0,this.error=null;try{let t=g.getAuthToken(),n=`${g.getBaseUrl?.()||`http://localhost:8000`}/api/reports/consumption-pdf?${new URLSearchParams({sector_name:this.selectedSector,date_from:this.dateFrom,date_to:this.dateTo,token:t}).toString()}`,r=document.createElement(`a`);r.href=n,r.download=`relatorio_consumo_${this.selectedSector}_${this.dateFrom}_${this.dateTo}.pdf`,document.body.appendChild(r),r.click(),r.remove(),setTimeout(()=>{this.generating=!1,e.store(`toast`)?.show(`PDF gerado com sucesso!`,`success`)},1e3)}catch(t){this.error=t?.message||`Erro ao gerar PDF.`,e.store(`toast`)?.show(this.error,`error`),this.generating=!1}}},formatDate(e){return e?new Date(e).toLocaleDateString(`pt-BR`,{day:`2-digit`,month:`2-digit`,year:`numeric`,hour:`2-digit`,minute:`2-digit`}):``},formatNumber(e,t=2){return e==null?`—`:Number(e).toLocaleString(`pt-BR`,{minimumFractionDigits:t,maximumFractionDigits:t})},formatCurrency(e){return e==null?`—`:`R$ `+Number(e).toLocaleString(`pt-BR`,{minimumFractionDigits:2,maximumFractionDigits:2})}}))}var $=!1;function dt(e){!$&&window.Alpine&&(ut(window.Alpine),$=!0),e.innerHTML=`
...
`,window.Alpine?.initTree(e)}document.addEventListener(`alpine:init`,()=>{pe(window.Alpine)}),document.addEventListener(`DOMContentLoaded`,()=>{document.title=e.APP_NAME,console.log(`[${e.APP_NAME}] v${e.VERSION} inicializado.`);let r=localStorage.getItem(`ef_theme`)||`light`;document.documentElement.setAttribute(`data-theme`,r),r===`dark`&&document.documentElement.classList.add(`dark`),window.addEventListener(`unhandledrejection`,e=>{e.preventDefault(),console.warn(`[LumenFlow] Promise não tratada:`,e.reason?.message||e.reason)});let i=document.getElementById(`app`);window.addEventListener(n,()=>{y.destroy(),D(),t.navigate(`/login`)}),t.register(`/`,()=>t.navigate(y.isAuthenticated()?`/sectors/select`:`/login`)),t.register(`/login`,k(()=>ve(i))),t.register(`/register`,k(()=>ge(i))),t.register(`/forgot-password`,k(()=>be(i))),t.register(`/reset-password`,k(()=>Se(i))),t.register(`/dashboard`,O(e=>Oe(e))),t.register(`/sectors/select`,()=>{if(!y.isAuthenticated()){t.navigate(`/login`);return}w.isMounted()&&w.unmount(),ot(i)}),t.register(`/sectors/:id/dashboard`,O(e=>lt(e))),t.register(`/transparency`,O(e=>Be(e))),t.register(`/sectors`,O(e=>je(e))),t.register(`/devices`,O(e=>Pe(e))),t.register(`/devices/:id`,O(e=>Le(e))),t.register(`/alerts`,O(e=>Xe(e))),t.register(`/goals`,O(e=>qe(e))),t.register(`/financial`,O(e=>$e(e))),t.register(`/tariffs`,O(e=>nt(e))),t.register(`/reports`,O(e=>dt(e))),t.register(`/settings`,O(e=>We(e))),t.notFound(()=>t.navigate(`/`)),t.start()});